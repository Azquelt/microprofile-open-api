...
Vendors may provide a separate user interface to display the contents of the OpenAPI
document in an easier to read format. If such a user interface is provided, it should
be made available to users at `/openapi/ui`.
